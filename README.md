...
- **10 阶段调查流程** — 身份验证 → 学生追踪 → 发表分析 → 合作网络 → 经费分析 → 社交舆情 → 行业宏观趋势 → 多维评分 → 锐评 → 报告生成
...
- **导师锐评（v1.1 新增）** — 7问深度剖析 + Deal-Breaker一票否决机制，不骑墙、敢下结论
- **行业宏观趋势（v1.1 新增）** — 领域生命周期定位（萌芽/上升/成熟/衰退/夕阳）+ 就业前景 + 技术颠覆风险
...
DeepTutor 从 **11 个维度** 对导师进行量化评估（中国版本）：

| # | 维度 | 权重 | 说明 |
|---|------|------|------|
| 1 | 领域宏观趋势 | 10% | 生命周期定位、资金趋势、就业前景、技术颠覆风险 |
| 2 | 发表成果与质量 | 12% | 总产出、h-index、期刊层次分布 |
| 3 | 学生培养实绩 | 13% | 毕业生去向、学位完成时间、学生发表 |
| 4 | 平台与资源 | 12% | 经费、设备、合作网络、学科排名 |
| 5 | 独立性与成长空间 | 8% | 课题自主权、一作/通讯机会 |
| 6 | 职业轨迹与势头 | 5% | 职称晋升速度、奖项荣誉、学术影响力趋势 |
| 7 | PUA/PUSH 风险 | 10% | 网络舆情、学生流失率、毕业延期比例 |
| 8 | 时间自由度 | 8% | 是否允许实习/考公/副业、作息要求 |
| 9 | 毕业目标匹配 | 7% | 导师风格与你的职业目标的契合度 |
| 10 | **导师锐评** | 10% | 7问深度剖析、Deal-Breaker一票否决、直觉综合判断 |
| 11 | **退休与稳定性风险** | 5% | 年龄、tenure状态、经费到期、接班安排 |
